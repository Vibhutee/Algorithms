...
public class BatcherBanyan16 {
     ...
     *
     * @param numbers - Provides an input of int array. Eg. numbers = {12,4,2,8,5}
    ...
    private static String[] convertingToBinary(int[] numbers) {
        ...
        for (int i = 0; i < numbers.length; i++) {
            ...
            binaryNumbers[i] = String.format("%4s", Integer.toBinaryString(numbers[i]))
                    .replace(' ', '0');
        }
    ...
    private static void banyanImplementation(int[] numbers, String[] binaryNumbers) {
        ...
        inputPorts.put(8, "A1");
        inputPorts.put(9, "A2");
        inputPorts.put(10, "A3");
        inputPorts.put(11, "A4");
        inputPorts.put(12, "A5");
        inputPorts.put(13, "A6");
        inputPorts.put(14, "A7");
        inputPorts.put(15, "A8");
        ...
        for (int i = 0; i < numbers.length; i++) {
            ...
            if (path2 != null)
                path3 = switchC_to_switchD(path2, binaryNumbers[i]);
            if (path3 != null)
                outputPort = switchD_to_output(path3, binaryNumbers[i]);
            System.out.print("-----------------------------------------------------------------\n");
            System.out.println("|        Path :  " + initialPort + " --> " + path1 + " --> "
                    + path2 + " --> " + path3 + " --> " + outputPort + "           |");
    ...
    private static String switchA_to_switchB(String initialPort, String binaryNumber) {
        ...
        if (initialPort.equals("A1"))
            return direction == '0' ? "B1" : "B5";

        if (initialPort.equals("A2"))
            return direction == '0' ? "B2" : "B6";

        if (initialPort.equals("A3"))
            return direction == '0' ? "B3" : "B7";

        if (initialPort.equals("A4"))
            return direction == '0' ? "B4" : "B8";

        if (initialPort.equals("A5"))
            return direction == '0' ? "B1" : "B5";

        if (initialPort.equals("A6"))
            return direction == '0' ? "B2" : "B6";

        if (initialPort.equals("A7"))
            return direction == '0' ? "B3" : "B7";

        if (initialPort.equals("A8"))
            return direction == '0' ? "B4" : "B8";
    ...
    private static String switchB_to_switchC(String initialPort, String binaryNumber) {
        ...
        if (initialPort.equals("B1"))
            return (direction == '0') ? "C1" : "C3";

        if (initialPort.equals("B2"))
            return direction == '0' ? "C2" : "C4";
        ...
        if (initialPort.equals("B5"))
            return direction == '0' ? "C5" : "C7";

        if (initialPort.equals("B6"))
            return direction == '0' ? "C6" : "C8";

        if (initialPort.equals("B7"))
            return direction == '0' ? "C5" : "C7";

        if (initialPort.equals("B8"))
            return direction == '0' ? "C6" : "C8";
    ...
    /**
     * This method is used to find the path from switch C to switch D
     *
     * @param initialPort  - Value of the port from which value is coming. Eg. "C5"
     * @param binaryNumber - Binary equivalent of the number. Eg. {"1100"}
     * @return - Returns the destination port in switch D. Eg. "D8"
     */
    private static String switchC_to_switchD(String initialPort, String binaryNumber) {
        char direction = binaryNumber.charAt(2);

        if (initialPort.equals("C1"))
            return direction == '0' ? "D1" : "D2";

        if (initialPort.equals("C2"))
            return direction == '0' ? "D1" : "D2";

        if (initialPort.equals("C3"))
            return direction == '0' ? "D3" : "D4";

        if (initialPort.equals("C4"))
            return direction == '0' ? "D3" : "D4";

        if (initialPort.equals("C5"))
            return direction == '0' ? "D5" : "D6";

        if (initialPort.equals("C6"))
            return direction == '0' ? "D5" : "D6";

        if (initialPort.equals("C7"))
            return direction == '0' ? "D7" : "D8";

        if (initialPort.equals("C8"))
            return direction == '0' ? "D7" : "D8";
    ...
    /**
     * This method is used to find the path from switch D to Output port
     *
     * @param initialPort  - Value of the port from which value is coming. Eg. "D4"
     * @param binaryNumber - Binary equivalent of the number. Eg. {"1001"}
     * @return - Returns the output port number. Eg. "output13"
     */
    private static String switchD_to_output(String initialPort, String binaryNumber) {
        char direction = binaryNumber.charAt(3);

        if (initialPort.equals("D1"))
            return direction == '0' ? "output1" : "output2";

        if (initialPort.equals("D2"))
            return direction == '0' ? "output3" : "output4";

        if (initialPort.equals("D3"))
            return direction == '0' ? "output5" : "output6";

        if (initialPort.equals("D4"))
            return direction == '0' ? "output7" : "output8";

        if (initialPort.equals("D5"))
            return direction == '0' ? "output9" : "output10";

        if (initialPort.equals("D6"))
            return direction == '0' ? "output11" : "output12";

        if (initialPort.equals("D7"))
            return direction == '0' ? "output13" : "output14";

        if (initialPort.equals("D8"))
            return direction == '0' ? "output15" : "output16";
